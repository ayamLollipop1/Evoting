    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <div class="card">
                        <h5 class="card-header">Add Position</h5>
                        <div class="card-body">
                            <form method="POST" action="../backends/create-position.php" autocomplete="yes" autocapitalize="yes">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="">Position name</label>
                                        <div class="form-group">
                                            <input type="text" name="position" id="form2Example1" class="form-control" placeholder="position name" r class="form-control" equired />
                                        </div>
                                    </div>
                                </div>
