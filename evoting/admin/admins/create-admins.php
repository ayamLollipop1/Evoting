        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="../backends/create_admin.php" enctype="multipart/form-data">
                <!-- Email input -->
                ...
                <div class="form-outline mb-4">
                  <input type="name" name="fname" id="form2Example1" class="form-control" placeholder="first name" />
                </div>

                <div class="form-outline mb-4">
                  <input type="name" name="sname" id="form2Example1" class="form-control" placeholder="surname" />
                </div>
